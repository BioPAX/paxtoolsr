...
**NOTE:** **downloadPc2** may take several minutes to complete. It is suggested that the results of this command be saved locally rather than using this command frequently. 
